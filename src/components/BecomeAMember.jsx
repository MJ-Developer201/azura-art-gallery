  ...
  return (
    <div className='member-container'>
      <div style={{ marginTop: '1rem' }} className='member-div'>
        <h1 style={{ color: 'white', fontSize: ' 4.2rem', letterSpacing: '0.2rem' }}>Purchase Ticket</h1>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginBlock: '1rem' }}>
        ...
        <div className='container mt-5 bg-black-transparent p-2 rounded'>
          <div style={{ marginBottom: '6%' }} className='membership-header text-center '>
            <h1 style={{ fontSize: '3em' }} className='text-white'>
              Join Our Art Gallery Membership
            </h1>
            <p className='text-white'>Unlock exclusive benefits and immerse yourself in the world of art!</p>
              ...
              <div className='col-md-6'>
                <div className='card mb-3'>
                  <div className='card-body'>
                    ...
                    <p className='card-text'>1-year access to standard benefits</p>
      ...
      <Dialog open={open} onClose={handleClose}>
        <DialogContent>
          ...
          <ul
            style={{ color: 'white', listStyle: 'none', textAlign: 'center', marginTop: 50 }}
            className='text-white'
          >
            <li
              style={{
          ...
          <Divider style={{ marginTop: '5em', backgroundColor: 'black', color: 'black' }} />
          <h2 style={{ color: 'black', textAlign: 'center', listStyle: 'none' }} className=''>
            Premium Benefits
          </h2>
          <Divider style={{ backgroundColor: 'black', color: 'black' }} />
          <ul

    ...
    <>
      <Navbar className='header-div' id='top'>
        <Container fluid className='nav-interior'>
          ...
          <div className='links header-right' style={{ display: 'flex', marginRight: '1rem' }}>
            <Link style={{ textDecoration: 'none', color: 'black' }} to='/'>
              <p style={{ marginLeft: '20px', fontSize: 16 }}>Home</p>
            </Link>
            <Link style={{ textDecoration: 'none' }} to={'/member'}>
              <a style={{ textDecoration: 'none' }} href=''>
                <p style={{ marginLeft: '20px', fontSize: 16, color: 'black' }}>Tickets</p>
              </a>
            </Link>
            <Link style={{ textDecoration: 'none' }} to={'/events'}>
              <a style={{ textDecoration: 'none' }} href='#footer'>
                <p style={{ marginLeft: '20px', fontSize: 16, color: 'black' }}>Events</p>
              </a>
            </Link>
            <Link style={{ textDecoration: 'none', color: 'black' }} to={'/member'}>
              <p style={{ marginLeft: '20px', fontSize: 16, textDecoration: 'none' }}>Membership</p>
            </Link>
          </div>

          <div className='dropdown'>
            <MenuIcon onClick={handleOpenDropdown}>Dropdown</MenuIcon>
            <Menu anchorEl={anchorElement} open={Boolean(anchorElement)} onClose={handleCloseDropdown}>
